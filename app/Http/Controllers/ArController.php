...
class ArController extends Controller
{
    ...
    /**
     * @OA\Get(
     *     path="/api/v1/ar/detail",
     *     operationId="/api/v1/ar/detail",
     *     tags={"Ar Content"},
     *     @OA\Parameter(
     *         name="lang",
     *         in="query",
     ...
     *         name="type",
     *         in="query",
     *         description="The type parameter in query, type in list indoor,content,brand",
     *         required=true,
     *         @OA\Schema(type="string")
     *     ),
     *     @OA\Parameter(
     *         name="target_id",
     *         in="query",
     *         description="The easy ar id parameter in query",
     *         required=true,
     *         @OA\Schema(type="string")
     *     ),
     *     @OA\Response(
